(function($) {
    ...
    // $(".made-image").removeClass("made-image");},function() {$("img.made-image").remove();
    //  $(".made-image").addClass("made-image");});
    ...
    $(document).ready(function() {
        $("a#ga-what-click").each(function() {
            var href = $(this).attr("href");
            var target = $(this).attr("target");
            var text = $(this).text();
            $(this).click(function(event) { // when someone clicks these links
                event.preventDefault(); // don't open the link yet
                var chunk = gtag(["trackEvent", "Link", "Clicked", href, text, 1, false])
                console.log(chunk);
